...
function inner(id,en,ja,body){if(id==='service'||id==='works'||id==='company') return body; return `<section class="page-hero"><div class="wrap"><nav class="breadcrumbs" aria-label="パンくず"><a href="index.html">HOME</a><span aria-hidden="true">/</span><span>${ja}</span></nav><p class="eyebrow">SOKEN CONSTRUCTION</p><h1>${en}</h1><p class="page-ja">${ja}</p></div></section><section class="section"><div class="wrap page-body">${body}</div></section>${id==='contact'?'':contact}`;}
=======
// Dependency-free page assembly. Run `node build-pages.cjs` after editing shared markup.
const fs = require('node:fs');
const voidElements = new Set(['area','base','br','col','embed','hr','img','input','link','meta','param','source','track','wbr']);
...
>>>>>>> e521118efbfa5c18cc72809a9ee66b34e04b3424
const pages = {
...
<<<<<<< HEAD
 works:['WORKS','施工実績','住宅・店舗・オフィス・地域施設まで、用途や規模の異なる建築に向き合う株式会社 蒼建の施工実績。',`<section class="page-hero service-page-hero works-page-hero"><div class="wrap"><nav class="breadcrumbs" aria-label="パンくず"><a href="index.html">HOME</a><span aria-hidden="true">/</span><span>施工実績</span></nav><div class="service-hero-layout"><div><p class="eyebrow">SOKEN CONSTRUCTION</p><h1>WORKS</h1><p class="page-ja">施工実績</p></div><div class="service-hero-copy works-hero-copy"><p class="service-hero-title"><span class="service-line">街に残る、</span><br>私たちの仕事。</p><p>住まい、商い、働く場所、地域の居場所。<br>用途や規模が違っても、使う人を想うことは変わりません。</p><p>一つひとつの場所に向き合い、<br>街のこれからへつながる建物をつくります。</p></div></div></div></section>
<section class="works-portfolio" aria-label="施工実績一覧"><div class="works-projects"><article class="works-project" id="house"><figure class="works-project-image"><img src="assets/images/works-house.webp" alt="緑の庭と大きな開口部を備えた二階建て住宅の外観" width="1448" height="1086" loading="lazy" decoding="async"></figure><div class="works-project-copy"><div class="works-project-meta"><span class="works-project-number">01</span><p>住宅</p></div><h2>光と庭をつなぐ家</h2><p>庭と室内がゆるやかにつながる住まい。大きな開口から光と緑を取り込み、家族が集まる場所に、季節の変化を感じられる余白をつくりました。</p></div></article>
<article class="works-project works-project--reverse" id="shop"><figure class="works-project-image works-project-image--bakery"><img src="assets/images/works-bakery.webp" alt="ガラス面と木材、植栽が調和するベーカリーの外観" width="1086" height="1448" loading="lazy" decoding="async"></figure><div class="works-project-copy"><div class="works-project-meta"><span class="works-project-number">02</span><p>店舗・商業施設</p></div><h2>焙煎のベーカリー</h2><p>街角に開かれた、木の温もりを感じるベーカリー。店内の気配が自然に伝わるガラス面と、訪れる人を迎える植栽を整え、日常に馴染む佇まいを目指しました。</p></div></article>
<article class="works-project" id="office"><figure class="works-project-image"><img src="assets/images/works-office.webp" alt="自然光と植栽を取り込んだ開放的なオフィス空間" width="1448" height="1086" loading="lazy" decoding="async"></figure><div class="works-project-copy"><div class="works-project-meta"><span class="works-project-number">03</span><p>オフィス</p></div><h2>光が巡るワークプレイス</h2><p>窓辺の光と緑が、働く場所の奥まで届くオフィス。集中と対話の場を緩やかに分け、働く人が気持ちよく行き来できる、明るく柔軟な空間に整えました。</p></div></article>
<article class="works-project works-project--reverse" id="renovation"><figure class="works-project-image"><img src="assets/images/works-renovation.webp" alt="既存の木の柱と梁を活かして再生した住宅の室内" width="1536" height="1024" loading="lazy" decoding="async"></figure><div class="works-project-copy"><div class="works-project-meta"><span class="works-project-number">04</span><p>リノベーション</p></div><h2>木を活かした住まいの再生</h2><p>受け継がれてきた柱と梁を残し、今の暮らしに合う住まいへ。既存の木が持つ表情を丁寧に整え、新しい素材と馴染ませながら、時間のつながりを感じる空間に再生しました。</p></div></article>
<article class="works-project" id="landscape"><figure class="works-project-image"><img src="assets/images/works-plaza.webp" alt="植栽と歩行空間、ベンチを備えた建物前の広場" width="1536" height="1024" loading="lazy" decoding="async"></figure><div class="works-project-copy"><div class="works-project-meta"><span class="works-project-number">05</span><p>外構・ランドスケープ</p></div><h2>緑と人をつなぐ外構計画</h2><p>建物への動線に植栽と小さな居場所を重ねた外構計画。歩く人、立ち止まる人、それぞれが心地よく過ごせるよう、舗装と緑のバランスを丁寧に整えました。</p></div></article>
<article class="works-project works-project--reverse" id="community"><figure class="works-project-image"><img src="assets/images/works-community.webp" alt="大きな軒と広場を備え、地域に開かれた交流施設の外観" width="1536" height="1024" loading="lazy" decoding="async"></figure><div class="works-project-copy"><div class="works-project-meta"><span class="works-project-number">06</span><p>公共・地域施設</p></div><h2>地域にひらく交流センター</h2><p>大きな軒と広場が、屋内外の活動を緩やかにつなぐ地域施設。誰もが立ち寄りやすく、催しや交流の形に合わせて使える、街の新しい居場所を目指しました。</p></div></article></div></section>
<section class="service-contact works-contact"><div class="wrap service-contact-inner"><div><p class="eyebrow">CONTACT</p><h2>次の場所を、<br>いっしょにつくる。</h2><p>住宅から店舗、地域の施設まで。<br>計画の初期段階から、お気軽にご相談ください。</p></div><div class="service-contact-actions">${link('contact.html','施工について相談する','button')}<a class="service-phone" href="tel:00000000000"><span>PHONE</span>000-0000-0000</a></div></div></section>`],
 company:['COMPANY','会社案内','一つひとつの仕事に誠実に向き合い、人と街のこれからを支える株式会社 蒼建の理念と会社案内。',`<section class="page-hero service-page-hero company-page-hero"><div class="wrap"><nav class="breadcrumbs" aria-label="パンくず"><a href="index.html">HOME</a><span aria-hidden="true">/</span><span>会社案内</span></nav><div class="service-hero-layout"><div><p class="eyebrow">SOKEN CONSTRUCTION</p><h1>COMPANY</h1><p class="page-ja">会社案内</p></div><div class="service-hero-copy company-hero-copy"><p class="service-hero-title"><span class="service-line">街とともに、</span><br>未来をつくる。</p><p>建物をつくることは、<br>その場所で続いていく時間をつくること。</p><p>私たちは、一つひとつの仕事に誠実に向き合い、<br>人と街のこれからを支える建設会社でありたいと考えています。</p></div></div></div></section>
<section class="section company-message"><div class="wrap"><div class="company-section-head"><div><p class="eyebrow"><span>01</span>MESSAGE</p><h2 class="section-title">現場に立ち、<br>人と向き合う。</h2></div><p class="company-section-note">PEOPLE FIRST.<br>BUILD WITH HONESTY.</p></div><div class="company-message-layout"><figure class="company-message-image"><img src="assets/images/company-message.webp" alt="建築現場で図面を確認しながら対話する代表者と若手社員" width="1536" height="1024" loading="lazy" decoding="async"></figure><div class="company-message-text"><p>私たち蒼建が大切にしているのは、<br>建物だけを見るのではなく、<br>その先にいる人を見ることです。</p><p>どれだけ技術が進んでも、<br>建設の仕事は、人と人との対話から始まります。</p><p>お客様の声を聞き、<br>設計者や協力会社と考え、<br>現場で働く仲間と力を合わせる。</p><p>そうした一つひとつの積み重ねが、<br>長く愛される建物につながると考えています。</p><p>これからも地域に根ざし、<br>目の前の仕事に誠実に向き合いながら、<br>街の未来をつくっていきます。</p><p class="company-signature"><span>代表取締役</span>架空 太郎</p></div></div></div></section>
<section class="company-philosophy" id="philosophy"><div class="wrap"><p class="eyebrow"><span>02</span>PHILOSOPHY</p><div class="company-philosophy-layout"><h2>いい仕事は、<br>いい未来に<br>つながっている。</h2><div class="company-philosophy-copy"><p>今日の丁寧な仕事が、<br>誰かの明日の安心になる。</p><p>建物をつくるだけでなく、<br>人を育て、技術を磨き、<br>地域とともに歩んでいく。</p><p>目の前の仕事に誠実であること。<br>それが、私たち蒼建の原点です。</p></div></div><p class="company-philosophy-word" aria-hidden="true">GOOD WORK, GOOD FUTURE.</p></div></section>
<section class="section company-values"><div class="wrap"><div class="company-section-lead"><div><p class="eyebrow"><span>03</span>OUR VALUES</p><h2 class="section-title">変わらない、<br>3つの姿勢。</h2></div><p>技術や環境が変わっても、仕事の根にある姿勢は変わりません。</p></div><div class="company-values-list"><article><span>01</span><p class="company-value-en">HONESTY</p><h3>誠実</h3><p>目の前の仕事にも、人にも、<br>正直に向き合う。</p><p>見えない部分まで丁寧に積み重ねます。</p></article><article><span>02</span><p class="company-value-en">CRAFT</p><h3>技術</h3><p>経験を受け継ぎながら、<br>新しい知識と技術を学び続ける。</p><p>より良い建物をつくるために、<br>昨日より一歩前へ進みます。</p></article><article><span>03</span><p class="company-value-en">COMMUNITY</p><h3>地域</h3><p>建物は、街の風景の一部になります。</p><p>地域とのつながりを大切にし、<br>その場所のこれからまで考えます。</p></article></div></div></section>
<section class="section company-profile"><div class="wrap company-profile-layout"><div><p class="eyebrow"><span>04</span>COMPANY PROFILE</p><h2 class="section-title">会社概要</h2></div><dl class="company-profile-list"><div><dt>会社名</dt><dd>株式会社 蒼建</dd></div><div><dt>英語表記</dt><dd>SOKEN CONSTRUCTION</dd></div><div><dt>代表者</dt><dd>代表取締役　架空 太郎</dd></div><div><dt>所在地</dt><dd>福岡県福岡市（架空）</dd></div><div><dt>事業内容</dt><dd><span>建築工事</span><span>改修・リノベーション</span><span>土木・外構工事</span></dd></div><div><dt>電話番号</dt><dd><a href="tel:00000000000">000-0000-0000</a></dd></div></dl></div></section>
<section class="company-access"><div class="wrap"><div class="company-access-head"><div><p class="eyebrow"><span>05</span>ACCESS</p><h2>地域に根ざし、<br>街とともに。</h2></div><address><strong>福岡県福岡市（架空）</strong><p>福岡を拠点に、<br>建築・改修・土木工事を通して<br>地域の暮らしと街づくりに向き合っています。</p></address></div><p class="company-access-word" aria-hidden="true">FUKUOKA</p></div></section>
<section class="service-contact company-contact"><div class="wrap service-contact-inner"><div><p class="eyebrow">CONTACT</p><h2>次の場所を、<br>いっしょにつくる。</h2><p>住宅から店舗、地域の施設まで。<br>計画の初期段階から、お気軽にご相談ください。</p></div><div class="service-contact-actions">${link('contact.html','施工について相談する','button')}<a class="service-phone" href="tel:00000000000"><span>PHONE</span>000-0000-0000</a></div></div></section>`],
