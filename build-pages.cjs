...
function inner(id,en,ja,body){return `<section class="page-hero"><div class="wrap"><nav class="breadcrumbs" aria-label="パンくず"><a href="index.html">HOME</a><span aria-hidden="true">/</span><span>${ja}</span></nav><p class="eyebrow">SOKEN CONSTRUCTION</p><h1>${en}</h1><p class="page-ja">${ja}</p></div></section><section class="section"><div class="wrap page-body">${body}</div></section>${id==='contact'?'':contact}`;}
const pages = {
 service:['SERVICE','事業内容','計画から施工、その先まで。',`<h2 class="section-title">つくりたい想いを、<br>相談できるパートナーに。</h2><p class="copy">土地や建物の条件、ご予算、これからの使い方。まだ決まっていないことも含めてお聞かせください。現場を知る視点から、実現に向けた道筋を一緒に考えます。</p><article class="detail-block" id="architecture"><p class="eyebrow">01 / ARCHITECTURE</p><h2>建築工事</h2><p>戸建て住宅、店舗、オフィス、小規模施設の新築に対応。設計者や専門工事の協力会社と連携し、品質・工程・安全を管理します。</p></article><article class="detail-block" id="renovation"><p class="eyebrow">02 / RENOVATION</p><h2>改修・リノベーション</h2><p>住宅の間取り変更、店舗の内装、事業所の機能改善など。既存建物の状態を確認し、使い続けるための改修をご提案します。</p></article><article class="detail-block" id="civil"><p class="eyebrow">03 / CIVIL ENGINEERING</p><h2>土木・外構工事</h2><p>敷地の整備、駐車場、アプローチ、排水設備など。建物とのつながりや周辺環境を考え、使いやすく安全な基盤を整えます。</p></article>`],
